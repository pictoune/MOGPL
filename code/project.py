        ...
        for edge in edges:
            if (selected_node == edge.u) and (not nodes[edge.v]["visited"]):
                ...
                if (
                    ...
                    > nodes[edge.u]["distance"] + edge.weight
                ):
                    nodes[neighbor]["distance"] = (
                        nodes[edge.u]["distance"] + edge.weight
                    )
...
for edge in E:
    print(
        "%s,%d" % (edge.u[0], edge.u[1]),
        " => ",
        "%s,%d" % (edge.v[0], edge.v[1]),
        " | weight =",
        edge.weight,
    )
...
print(
    "type IV path (smallest distance) between a and g : ",
    path_4,
...
print(
    "Solver Gurobi for type IV between a and g : ",
    path_5,
    " (may not be the same as the previous result) and their distance is :",
    dis2,
    "\n",
)
